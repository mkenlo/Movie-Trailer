...
empire =media.TvShow("Empire",
                    ...
                    "https://www.youtube.com/watch?v=dBzu_jKLJek",
                     3,36,"HBO");
being_mary_jane = media.TvShow("Being Mary Jane",
                              "The series centers on successful broadcast journalist Mary Jane Paul and her professional and private family life while searching for 'Mr. Right'",
                              img_path+"\Being_Mary_Jane_logo.png",
                              "https://www.youtube.com/watch?v=UqZICwnqf4k",
                               4,32,"dont know");
games_of_thrones=media.TvShow("Games of Thrones",
...
house_of_cards=media.TvShow("House of Cards",
                         "story of Frank Underwood, a Democrat from South Carolina's 5th congressional district and House Majority Whip who, after being passed over for appointment as Secretary of State, initiates an elaborate plan to get himself into a position of greater power, aided by his wife, Claire Underwood",
                         img_path+"\House_of_Cards_title_card.png",
                         "https://www.youtube.com/watch?v=ULwUzF1q5w4",
                          4,28,"Netflix");
blacklist=media.TvShow("the BlackList",
                         "",
                         img_path+"\The-Blacklist-logo.png",
                         "https://www.youtube.com/watch?v=JGBIimq1I3A",
                          5,75,"NBC");
orange_black=media.TvShow("Orange is the new Black",
                          "The series revolves around Piper Chapman, a woman in her 30s living in New York City, who is sentenced to 15 months in Litchfield Penitentiary, a minimum-security women's federal prison (operated by the 'Federal Department of Corrections', a fictional version of the Federal Bureau of Prisons) in upstate New York",
